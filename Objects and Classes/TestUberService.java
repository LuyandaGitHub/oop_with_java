public class TestUberService {
     ...
     public static void main(final String[] args) {
          ...
          if (service.getName().equals(service.getName()) && service.getCostPerMinute() == 70
                    && service.getCostPerKilometre() == 700 && service.getBaseFare() == 500
          ...
          if (service.getCostPerKilometre() == 700 && service.getName().equals("UberXL")
                    && service.getCostPerMinute() == 70 && service.getBaseFare() == 500
                    && service.getCancellationFee() == 2500) {
               System.out.println("Pass");
          } else {
               System.out.println("Fail");
          ...
          service = new UberService();
          service.setDetails("UberX", 70, 700, 500, 2500);
          if (service.getBaseFare() == 500 && service.getName().equals("UberX") && service.getCostPerMinute() == 70
                    && service.getCostPerKilometre() == 700 && service.getCancellationFee() == 2500) {
               System.out.println("Pass");
          } else {
               System.out.println("Fail");
          }
          ...
          if (service.getCancellationFee() == 2500 && service.getName().equals("UberX")
                    && service.getCostPerMinute() == 70 && service.getCostPerKilometre() == 700
          ...
          if (service.getName().equals("UberExtraLarge") && service.getCostPerMinute() == 70
                    && service.getCostPerKilometre() == 700 && service.getBaseFare() == 2000
                    && service.getCancellationFee() == 2500) {
               System.out.println("Pass");
          } else {
               System.out.println("Fail");
          ...
          if (service.getBaseFare() == 2300 && service.getName().equals("UberXL") && service.getCostPerMinute() == 70
                    && service.getCostPerKilometre() == 700 && service.getCancellationFee() == 2500) {
               System.out.println("Pass");
          } else {
               System.out.println("Fail");
          ...
          if (Math.abs(service.calculateFare(3.0, 7.0) - 5610.0) < EPSILON && service.getName().equals("UberX")
                    && service.getCostPerMinute() == 70 && service.getCostPerKilometre() == 700
                    && service.getBaseFare() == 500 && service.getCancellationFee() == 2500) {
               System.out.println("Pass");
          } else {
               System.out.println("Fail");
          }
